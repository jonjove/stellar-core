...
void makeValid(SponsorshipEntry& s);
void makeValid(PreauthorizationEntry& p);
...
SponsorshipEntry generateValidSponsorshipEntry(size_t b = 3);
std::vector<SponsorshipEntry> generateValidSponsorshipEntries(size_t n);

PreauthorizationEntry generateValidPreauthorizationEntry(size_t b = 3);

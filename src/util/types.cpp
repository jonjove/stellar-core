...
LedgerEntryKey(LedgerEntry const& e)
{
    ...
    case SPONSORSHIP:
        k.sponsorship().createdBy = d.sponsorship().createdBy;
        k.sponsorship().sponsorshipID = d.sponsorship().sponsorshipID;
        break;

    case PREAUTHORIZATION:
        k.preauthorization().accountID = d.preauthorization().accountID;
        k.preauthorization().asset = d.preauthorization().asset;
        break;

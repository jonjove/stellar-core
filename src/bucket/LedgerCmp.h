...
struct LedgerEntryIdCmp
{
        ...
        -> decltype(a.type(), b.type(), bool())
    {
        ...
        case SPONSORSHIP:
            return lexCompare(
                a.sponsorship().createdBy, b.sponsorship().createdBy,
                a.sponsorship().sponsorshipID, b.sponsorship().sponsorshipID);
        case PREAUTHORIZATION:
            return lexCompare(
                a.preauthorization().accountID, b.preauthorization().accountID,
                a.preauthorization().asset, b.preauthorization().asset);
        }
        return false;
    }
};
